					...
					<form action="<%=request.getContextPath()%>/addTicketController"
						...
						<div class="row">
							<input type="text" class="form-control" id="id" name="id"
								value="${ticket.ticket_ID }" hidden="true">
							<div class="col-md-3">
							...
							<div class="form-group col-md-7">
								...
								<div class="invalid-feedback" id="invalid-customerName">Can
									not be null</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="input-group col-md-7">
								...
								<div class="invalid-feedback" id="invalid-booktime">Can
									not be null</div>
							</div>
						</div>
						<p></p>
							...
							<div class="row">
								...
								<div class="input-group col-md-7">
									<input type="date" class="form-control" id="departureDate"
										name="departureDate"
										<c:forEach items="${trips}" var="trips">
											<c:if test="${trips.trip_ID == ticket.trip_ID}">
												value = "${trips.departureDate}"
											</c:if>
										</c:forEach>
										readonly>
								</div>
...
<script
	src="<%=request.getContextPath()%>/resources/js/myJavaScript.js"></script>
</html>