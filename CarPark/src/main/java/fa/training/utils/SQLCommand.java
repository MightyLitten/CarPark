...
public class SQLCommand {
	...
	public static String QUERY_DELETE_TICKET_BY_PARKING = "DELETE FROM Ticket WHERE licensePlate in ( SELECT licensePlate FROM Car WHERE park_ID = ?)";
	...
	public static String QUERY_EDIT_PARKING_LOT = "UPDATE Parkinglot SET name = ?, place=?, area=?, price=?, status=? WHERE park_ID= ?";

	public static String QUERY_ADD_PARKING_LOT = "INSERT INTO Parkinglot(name, area, place, price, status) VALUES (?,?,?,?,?) SELECT @@ROWCOUNT";

	public static String QUERY_DELETE_PARKING_LOT = "DELETE FROM Parkinglot WHERE park_ID = ?";

	public static String QUERY_GET_PARKING_LOT_BY_ID = "SELECT name, area, place, price, park_ID, status FROM Parkinglot WHERE park_ID = ?";
